...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'twentyten') ) ) : ?>
		...
		<?php endif; ?>
			...
			<div class="entry-utility">
				<?php hri_time_since( $post->post_date ) ?>
				<span class="meta-sep">|</span>
				<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'twentyten' ), __( '1 Comment', 'twentyten' ), __( '% Comments', 'twentyten' ) ); ?></span>
				<?php edit_post_link( __( 'Edit', 'twentyten' ), '<span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?>
			</div><!-- .entry-utility -->
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<h2 class="entry-title"><a href="<?php echo hri_link( get_permalink(), $lang, null, true); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>

	<?php if ( is_archive() || is_search() ) : // Only display excerpts for archives and search. ?>
			<div class="entry-summary">
				<?php the_excerpt();

				echo hri_link( hri_read_more(), $lang, null, true);
