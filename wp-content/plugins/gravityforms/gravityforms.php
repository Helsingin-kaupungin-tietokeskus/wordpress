...
// brbr 18.11.10
// removed define GRAVITY_MANAGER_URL
...
class RGForms{
    ...
    private static function is_gravity_page(){
		...
		$gf_pages = array("gf_edit_forms","gf_new_form","gf_entries","gf_settings","gf_export");
    ...
    public static function create_menu(){
        ...
        add_object_page(__('Forms', "gravityforms"), __("Forms", "gravityforms") . $update_icon , $has_full_access ? "gform_full_access" : $min_cap, $parent_menu["name"] , $parent_menu["callback"], GFCommon::get_base_url() . '/images/admin-icon.png');
...
//-------------- DASHBOARD PAGE -------------------------
    ...
    public static function dashboard(){
        ...
        if(sizeof($forms) > 0){
			...
			/* brbr 20.11.10: Valid dashboard page
			...
			*/
            ...
            <table class="widefat fixed" cellspacing="0" style="border:0px;">
                <thead>
					<tr>
						<th>Form Name</th>
						<th style="text-align:center">Unread Entries</th>
						<th>Last Entry</th>
					</tr>
                </thead>
