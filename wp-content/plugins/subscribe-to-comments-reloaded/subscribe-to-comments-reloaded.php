...
function subscribe_reloaded_show() {
	...
	//brbr: return instead of echo
	$html_to_show = "<!-- BEGIN: subscribe to comments reloaded -->" . html_entity_decode( stripslashes( $html_to_show ), ENT_QUOTES, 'UTF-8' ) ."<!-- END: subscribe to comments reloaded -->";
...
class wp_subscribe_reloaded {
	...
	public function confirmation_email( $_post_ID = 0, $_email = '' ) {
		...
		//brbr:
		$post           = hri_link(get_post( $_post_ID ));
		$post_permalink = hri_link(get_permalink( $_post_ID ));
